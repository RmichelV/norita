...
<form method="POST" action="{{ route('users.update',$user->id) }}">
        ...
        <div>
            ...
            <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$user->name" required autofocus autocomplete="name" placeholder="Ej. Michel"/>
        ...
        <div>
            ...
            <x-text-input id="last_name" class="block mt-1 w-full" type="text" name="last_name" :value="$user->last_name" required autofocus autocomplete="name" placeholder="Ej. Villalba"/>
        ...
        <div>
            ...
            <select
                ...
                required
            >
            <option value="" disabled {{ is_null($user->gender) ? 'selected' : '' }}>Selecciona un género</option>
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="$user->email" required autocomplete="username" placeholder="Ej. example@gmail.com"/>
